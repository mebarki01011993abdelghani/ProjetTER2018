package fr.univmrs.lif.view.wire;
...
//						if (p0.y <= p3.y) {
//							if (p3isTail)
//								points.add(index + 1, new Point2D(p0.x, p3.y));
//							else {
//								points.remove(index + 1);
//								points.add(index + 1, new Point2D(p0.x, p3.y));
//							}
...
//
//						if (p0isHead)
//							points.add(index + 1, new Point2D(p3.x, p0.y));
//						else {
//							points.remove(index + 1);
//							points.add(index + 1, new Point2D(p3.x, p0.y));
//						}
...
//	 */
//	int selectSegment(Point2D point) {
...
//		if (tail != null) {
//			if (p0.y == p1.y) {
//				points.add(end, new Point2D(point.x, p0.y));
//				points.add(end, point);
//				p1.y = point.y;
//			} else {
//				points.add(end, new Point2D(p0.x, point.y));
//				points.add(end, point);
//				p1.x = point.x;
//			}
//			return end - 1;
...
//		if (head != null) {
//			if (p0.y == p1.y) {
//				points.add(1, new Point2D(point.x, p0.y));
//				points.add(2, point);
//				p1.y = point.y;
//			} else {
//				points.add(1, new Point2D(p0.x, point.y));
//				points.add(2, point);
//				p1.x = point.x;
//			}
//			return 2;
...
//				p.setLocation(p.getX() + delta.getX(), p.y + delta.y);
//
//		} else {
...
//				setPoint(i, new Point2D(p.x + delta.x, p.y + delta.y));
//			}
//			Point2D p;
//			if (pn.y == pn1.y)
//				p = new Point2D(points.get(getSize() - 2).x, pn.y);
//			else
//				p = new Point2D(pn.x, points.get(getSize() - 2).y);
...
//		if (head == null) {
//			for (Point2D p : points)
//				p.setLocation(p.getX() + delta.x, p.y + delta.y);
//
//		} else {
//			Point2D p0 = points.get(0);
//			Point2D p1 = points.get(1);
...
//			Point2D p;
//			if (p0.y == p1.y)
//				p = new Point2D(points.get(1).x, p0.y);
//			else
//				p = new Point2D(p0.x, points.get(1).y);
//			points.add(1, p);
//		}
//		try {
//			debugg();
