...
public class EditorController {
	...
	public EditorController(Module module) {
		this.module = module;
	}
	...
	public List<Component> ComponentsContaining(Point2D p) {
...
//				l.add(c);
	...
	public Component ComponentContaining(Point2D p) {
	...
	public boolean isFree(Rectangle2D rect) {
//		for (Component c : module.getComponentList()) {
...
//		}
	...
	public boolean isFreePlace(Point2D point) {
		Rectangle2D rect = new Rectangle2D(point.getX() - Settings.GATE_WIDTH / 2, point.getY() - Settings.GATE_HEIGHT / 2, Settings.GATE_WIDTH, Settings.GATE_HEIGHT);
		return isFree(rect);
	}
...
//		}
	...
	public List<Wire> wiresContaining(Point2D point) {
...
//		}
	...
	public Wire wireContaining(Point2D point) {
		return null;
...
//			return wireList.get(0);
	...
	public Wire wireContaining(Point2D point, Wire wire) {
//		List<WireView> wireList = wiresContaining(point);
//		for (WireView w : wireList) {
//			if (w != wire)
//				return w;
//		}
		return null;
	...
	// le
	// gerer.
	int wireEdge(Wire wire, Point2D point) {
		return 0;
...
//		}
	...
	public void moveWireSegment(Wire wire, Point2D point, int selSegment) {
...
//			module.moveWireSegment(wire, point, selSegment);
	...
	public void moveWireEdge(Wire wire, int edge, Point2D point) {
//		if (!(wire == null && edge != -1)) {
//			if (edge == 0)
...
//		}
	...
	public void releaseWireEdge(Wire wire, int edge, Point2D point) {
//		if (wire == null || edge == -1)
//			return;
//		WireView wire2 = wireContaining(point, wire); // TODO attention ici on
//													// empeche les boucles
...
//	private void joint(WireView wire, int edge, WireView wire2, Point2D point) {
//		//TODO join deux cables
//		JointView joint = new JointView(module.getFreshGateName(), point, wire, edge, wire2);
//		module.addComponent(joint);
//	}

	public int indexOfSelectedPoint(Wire wire, Point2D point) {
		return 0;
